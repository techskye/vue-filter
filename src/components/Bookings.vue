<template>
	<div>
	  <p ref="messageRef">Thank you Tom Cruis!</p>
	  ...
	  <div
		v-for="book in books"
		:key="book.name"
		style="border: 1px dashed; margin-top: 12px"
	  >
		<div style="margin-bottom: 3px">
		  <span style="font-weight: bold; margin-right: 12px">Name:</span>
		  <span>{{ book.name }}</span>
		</div>
  
		<div>
		  <span style="font-weight: bold; margin-right: 12px">Author:</span>
